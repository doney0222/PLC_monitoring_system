...
class SubFrame_2(Frame):
    ...
    def initUI(self):
        ...
        # frame_1 component
        """machine info"""
        machine_name_1 = Label(self, text='Delta_Robot', font=self.font_25, fg='#FFFFFF', bg=color_frame_bg)
        machine_name_1.place(x=20, y=20, width=635, height=60)

        self.machine_image_1 = PhotoImage(file=os.path.join(current_file, 'Delta_Robot.png'))
        ...
        data_1_1_name = Label(self, text='L-Pos', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_1_1_name.place(x=45, y=430)

        data_1_2_name = Label(self, text='L-Vel', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_1_2_name.place(x=45, y=460)

        data_1_3_name = Label(self, text='C-Pos', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_1_3_name.place(x=245, y=430)

        data_1_4_name = Label(self, text='C-Vel', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_1_4_name.place(x=245, y=460)

        data_1_5_name = Label(self, text='R-Pos', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_1_5_name.place(x=445, y=430)

        data_1_6_name = Label(self, text='R-Vel', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_1_6_name.place(x=445, y=460)
        ...
        data_1_3_entry.place(x=310, y=433, width=80, height=22)

        data_1_4_entry = Entry(self, justify='right')
        data_1_4_entry.place(x=310, y=463, width=80, height=22)

        data_1_5_entry = Entry(self, justify='right')
        data_1_5_entry.place(x=510, y=433, width=80, height=22)

        data_1_6_entry = Entry(self, justify='right')
        ...
        data_1_1_unit.place(x=190, y=433)

        data_1_2_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_1_2_unit.place(x=190, y=463)

        data_1_3_unit = Label(self, text='mm', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_1_3_unit.place(x=390, y=433)

        data_1_4_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_1_4_unit.place(x=390, y=463)

        data_1_5_unit = Label(self, text='mm', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_1_5_unit.place(x=590, y=433)

        data_1_6_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_1_6_unit.place(x=590, y=463)
        ...
        # frame_2 component
        """machine info"""
        machine_name_2 = Label(self, text='Piano_Robot', font=self.font_25, fg='#FFFFFF', bg=color_frame_bg)
        machine_name_2.place(x=675, y=20, width=635, height=60)

        self.machine_image_2 = PhotoImage(file=os.path.join(current_file, 'Piano_Robot.png'))
        machine_image_2 = Label(self, image=self.machine_image_2, bg=color_frame_bg)
        ...
        self.run_button_on_2 = Button(self, image=self.run_btn_on_image_2_2, bg='#FFFFFF', bd=0, state='normal',command=self.btn_cmd_3)
        ...
        self.run_button_off_2_2 = Button(self, image=self.run_btn_off_image_2_2, bg='#FFFFFF', bd=0, state='normal', command=self.btn_cmd_4)
        ...
        data_2_1_name = Label(self, text='L-W', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_1_name.place(x=700, y=430)

        data_2_2_name = Label(self, text='L-B', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_2_name.place(x=700, y=460)

        data_2_3_name = Label(self, text='R-W', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_3_name.place(x=840, y=430)

        data_2_4_name = Label(self, text='R-B', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_4_name.place(x=840, y=460)

        data_2_5_name = Label(self, text='L-W', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_5_name.place(x=995, y=430)

        data_2_6_name = Label(self, text='L-B', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_6_name.place(x=995, y=460)

        data_2_7_name = Label(self, text='R-W', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_7_name.place(x=1145, y=430)

        data_2_8_name = Label(self, text='R-B', font=self.font_15, fg='#FFFFFF', bg=color_data_bg)
        data_2_8_name.place(x=1145, y=460)

        data_2_1_entry = Entry(self, justify='right')
        data_2_1_entry.place(x=745, y=433, width=55, height=22)

        data_2_2_entry = Entry(self, justify='right')
        data_2_2_entry.place(x=745, y=463, width=55, height=22)

        data_2_3_entry = Entry(self, justify='right')
        data_2_3_entry.place(x=885, y=433, width=55, height=22)

        data_2_4_entry = Entry(self, justify='right')
        data_2_4_entry.place(x=885, y=463, width=55, height=22)

        data_2_5_entry = Entry(self, justify='right')
        data_2_5_entry.place(x=1040, y=433, width=55, height=22)

        data_2_6_entry = Entry(self, justify='right')
        data_2_6_entry.place(x=1040, y=463, width=55, height=22)

        data_2_7_entry = Entry(self, justify='right')
        data_2_7_entry.place(x=1190, y=433, width=55, height=22)

        data_2_8_entry = Entry(self, justify='right')
        data_2_8_entry.place(x=1190, y=463, width=55, height=22)

        data_2_1_unit = Label(self, text='mm', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_1_unit.place(x=800, y=433)

        data_2_2_unit = Label(self, text='mm', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_2_unit.place(x=800, y=463)

        data_2_3_unit = Label(self, text='mm', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_3_unit.place(x=940, y=433)

        data_2_4_unit = Label(self, text='mm', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_4_unit.place(x=940, y=463)

        data_2_5_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_5_unit.place(x=1095, y=433)

        data_2_6_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_6_unit.place(x=1095, y=463)

        data_2_7_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_7_unit.place(x=1245, y=433)

        data_2_8_unit = Label(self, text='mm/s', font=self.font_12, fg='#FFFFFF', bg=color_data_bg)
        data_2_8_unit.place(x=1245, y=463)
    ...
    def btn_cmd_1(self):
        # worker 생성
        self.worker_1 = PLC_C()
        self.worker_2 = Thread.CheckPLC_3(self)
        self.worker_3 = Thread.Update_3(self)
    ...
    def btn_cmd_3(self):
        # worker 생성
        self.worker_4 = PLC_D()
        self.worker_5 = Thread.CheckPLC_4(self)
        self.worker_6 = Thread.Update_4(self)
